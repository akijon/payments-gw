...
- **Schema Migrations:** Managed sequentially via SQL migration files (`migrations/0001_init.sql` through `0017_merchant_catalog.sql`). Re-verify this reference stays current as new migrations land.
