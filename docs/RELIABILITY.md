...
| ------------------------------ | --------- | ---------------------- | ------------------------ | -------------------- | --------- |
| **Verifone Checkout API**      | 10,000 ms | Planned (Phase 7)      | Worker Concurrency Limit | 2 Retries w/ Backoff | In Review |
| **Verifone OAuth Token**       | 5,000 ms  | Planned (Phase 7)      | KV Token Cache           | 1 Immediate Retry    | In Review |
| **Verifone JWKS Fetch**        | 5,000 ms  | N/A (Cached in KV 24h) | KV Key Cache             | Fallback to cached   | Active    |
| **Landsbankinn Acquiring API** | 15,000 ms | Planned (Phase 7)      | Cron Isolation           | 2 Retries w/ Backoff | In Review |
